...
class RedisSemanticCache(ISemanticCache):
    ...
    def _deserialize(self, data: dict) -> QueryResult:
        ...
        return QueryResult(
            ...
            graph_summary_texts=data.get("graph_summary_texts", []),
            graph_seed_names=data.get("graph_seed_names", []),
            graph_seed_source=data.get("graph_seed_source", "empty"),
            graph_seed_strategy=data.get("graph_seed_strategy", "none"),
