"""
LLM Service adapters: OpenAI, Anthropic, Ollama, AzureOpenAI
All with retry (3x exponential backoff) and streaming support
"""
import asyncio
import logging
    ...
    async def generate(self, prompt: str,
        ...
        async def _call():
            async with httpx.AsyncClient(timeout=300.0) as client:
                ...
                # Strip thinking-mode tags (qwen3/qwen3.5 with thinking enabled)
                import re as _re
...
class AzureOpenAILLMService(ILLMService):
