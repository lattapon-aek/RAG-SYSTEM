...
- If INGESTION_SERVICE_API_KEY is set, requests must send that exact key via X-API-Key.
...
async def api_key_middleware(request: Request, call_next):
    ...
    env_api_key = os.getenv("INGESTION_SERVICE_API_KEY", os.getenv("RAG_API_KEY", ""))
